            ...
            <tbody>
              ${allReports.map(report => html`
                <tr>
                  ...
                  <td>${report.serviceAddress || html`<em>No address</em>`}</td>
                  <td>${report.serviceLatitude && report.serviceLongitude ? `${report.serviceLatitude}, ${report.serviceLongitude}` : html`<em>No coordinates</em>`}</td>
                  <td class="comment">${report.comment || html`<em>No comment</em>`}</td>
                  <td>${report.userIp}</td>
                  <td class="timestamp">${new Date(report.reportedAt).toLocaleString()}</td>
                </tr>
              `).join('')}
            </tbody>
          </table>
